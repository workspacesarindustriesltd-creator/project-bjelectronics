...
function SettingsView() {
  return (
    <div className="ops-settings-grid">
      <section className="ops-card"><header><div><p>Domain architecture</p><h3>Store surfaces</h3></div><CheckCircle weight="fill" className="ops-ok" /></header><div className="ops-domain"><i><Storefront /></i><div><strong>Customer storefront</strong><span>https://bjelectronics.shop</span></div><b>Store</b></div><div className="ops-domain"><i><ShieldCheck /></i><div><strong>Protected administrator portal</strong><span>https://bjelectronics.shop/admin</span></div><b>Admin</b></div></section>
